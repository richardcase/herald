...
func New(colors colorscheme.Colorscheme, width, height int, title string, reposFilter []string, reader func([]string) tea.Cmd) Model {
...
func (m Model) Init() tea.Cmd {
	...
	return tea.Batch(m.reader(m.reposFilter), m.loadingSpinner.Tick)
}
...
func (m Model) Update(msg tea.Msg) (tab.Tab, tea.Cmd) {
	...
	case tea.KeyMsg:
		...
		case "r":
			...
			return m, m.reader(m.reposFilter)
